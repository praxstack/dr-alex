# Dr. Alex Memory Architecture v3 Run Contract

**Frozen at:** 2026-08-23T20:15:00Z  
...
**Supersedes:** `RUN-CONTRACT-v2.md`  
**Authorization:** The user explicitly approved the content-free governing-source proposal and authorized this new versioned run contract.
...
The original narrative reports remain preserved in place as restricted clinical references. They are not governing inputs for v3. They must not be copied, quoted, committed, published, or sent to external reviewers.
...
The initial v3 candidate is RC3:
...
- `RUN-CONTRACT.md`, `GOVERNING-EVIDENCE-v3.md`, and `EVALUATOR-v3.md` after this freeze;
...
- RC3 and every candidate remain inside the diff and commit budgets.
...
- Maximum candidate diff: `1500` net changed lines per repository before a new human scope review.
...
- Governing-contract rollback: `RUN-CONTRACT-v2.md`, SHA-256 `a8ec61fac2cf36e185d6e643138953a9ab55b5b836281cdc7f3f7c67fd35f091`.
...
1. the exact architecture and change-spec candidate receives fresh independent PASS results under this content-free v3 baseline;
